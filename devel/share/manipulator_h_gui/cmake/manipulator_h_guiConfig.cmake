...
if("TRUE" STREQUAL "TRUE")
  set(manipulator_h_gui_SOURCE_PREFIX /home/DesktopFer/ratePosPaper/src/ROBOTIS-MANIPULATOR-H/manipulator_h_gui)
  set(manipulator_h_gui_DEVEL_PREFIX /home/DesktopFer/ratePosPaper/devel)
  ...
  set(manipulator_h_gui_INSTALL_PREFIX /home/DesktopFer/ratePosPaper/install)
...
if(NOT "/home/DesktopFer/ratePosPaper/src/ROBOTIS-MANIPULATOR-H/manipulator_h_gui/include;/usr/include/eigen3 " STREQUAL " ")
  set(manipulator_h_gui_INCLUDE_DIRS "")
  set(_include_dirs "/home/DesktopFer/ratePosPaper/src/ROBOTIS-MANIPULATOR-H/manipulator_h_gui/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulator_h_gui' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/DesktopFer/ratePosPaper/src/ROBOTIS-MANIPULATOR-H/manipulator_h_gui/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT manipulator_h_gui_NUM_DUMMY_TARGETS)
      set(manipulator_h_gui_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::manipulator_h_gui::wrapped-linker-option${manipulator_h_gui_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR manipulator_h_gui_NUM_DUMMY_TARGETS "${manipulator_h_gui_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::manipulator_h_gui::wrapped-linker-option${manipulator_h_gui_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND manipulator_h_gui_LIBRARIES "${interface_target_name}")
