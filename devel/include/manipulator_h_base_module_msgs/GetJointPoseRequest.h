...
bool operator==(const ::manipulator_h_base_module_msgs::GetJointPoseRequest_<ContainerAllocator1> & lhs, const ::manipulator_h_base_module_msgs::GetJointPoseRequest_<ContainerAllocator2> & rhs)
{
