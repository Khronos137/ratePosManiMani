...
bool operator==(const ::manipulator_h_base_module_msgs::GetKinematicsPoseRequest_<ContainerAllocator1> & lhs, const ::manipulator_h_base_module_msgs::GetKinematicsPoseRequest_<ContainerAllocator2> & rhs)
{
